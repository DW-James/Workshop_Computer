/*
 * USB MIDI device descriptors for Robodub.
 * Adapted from ComputerCard web_interface example.
 *
 * Product name "Robodub" is used by WebMIDI to identify the device.
 * Serial number is derived from the RP2040 flash chip's unique ID.
 */
...
char const *string_desc_arr[] = {
	...
	"Robodub",                    // 2: Product — used by WebMIDI to find this device
